        ...
        body: BlocProvider<UserPostCubit>(
            ...
            child: BlocListener<UserPostCubit, UserPostState>(listener:
              ...
              if (state is UserPostLoadFailed) {
                ...
                if (state.lstUserPost != null && state.lstUserPost.isNotEmpty)
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text("User Post Loaded Successfully"),
                    ),
                  );
              }
            }, child:
                                  ...
                                  onDismissed: (DismissDirection direction) {
                                    if (direction ==
                                      ...
                                      BlocProvider.of<UserPostCubit>(context)
                                          .deleteUserPost(
                                              lstUserPost[index].id);
                                      lstUserPost.removeAt(index);
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(SnackBar(
                                              content:
                                                  new Text("Item dismissed")));
                                    }
                                  },
                                  key: ValueKey(
                                      lstUserPost[index].id.toString()),
